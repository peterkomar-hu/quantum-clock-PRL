...
(For $\tilde n = 120$, this Rabi frequency, $\Omega = 10^5\gamma = 5.42\times
10^7~\text{s}^{-1}$ is small enough, that the nearest neighboring Rydberg level
is well out of resonance: The level spacing is $\sim 30~\text{GHz}$ between the
$6s120s$ and $6s119s$ levels.)
